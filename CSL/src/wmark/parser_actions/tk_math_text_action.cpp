...
WmarkParserMathTextAction::WmarkParserMathTextAction() noexcept
{
}
WmarkParserMathTextAction::~WmarkParserMathTextAction() noexcept
{
...
void WmarkParserMathTextAction::SetParameter(const std::any& param)
{
	m_pData = std::any_cast<RdParserActionMetaData*>(param);
}

bool WmarkParserMathTextAction::DoAction(const std::string& strToken, std::vector<std::string>& vecError)
{
	//text
