...
WmarkParserNtMIAction::WmarkParserNtMIAction() noexcept
{
}
WmarkParserNtMIAction::~WmarkParserNtMIAction() noexcept
{
...
void WmarkParserNtMIAction::SetParameter(const std::any& param)
{
	m_pData = std::any_cast<RdParserActionMetaData*>(param);
}

bool WmarkParserNtMIAction::DoAction(const std::string& strToken, std::vector<std::string>& vecError)
{
	//MI
