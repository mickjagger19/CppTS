...
WmarkParserBarAction::WmarkParserBarAction() noexcept
{
}
WmarkParserBarAction::~WmarkParserBarAction() noexcept
{
...
void WmarkParserBarAction::SetParameter(const std::any& param)
{
	m_pData = std::any_cast<RdParserActionMetaData*>(param);
}

bool WmarkParserBarAction::DoAction(const std::string& strToken, std::vector<std::string>& vecError)
{
	//text
